...
| --------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- |  
| **Politics**    | - Born as a response to COVID lock-down measures in France, closing all cultural places to visitors<br>- Attention in curating only texts pertaining to french literature                                                              | - GenAI is more an ideology than a proper technology (as explained by Khrys, a french tech researcher)[^4] <br>- The curation of texts is based on texts highlighting the dangers and downsides | - It is about time and how it is a social construct, with some reflections and personal opinions on society related to time                         |  
...
- Both the web and magic are political  
	- The web is a space for expression and expression is political as it carries opinions, moreover it has also become a preferred space and tool for political parties to advertise, gain voters and campaign[^5].   
	- A great part of magic history is about fighting repression; think of witches hunts, and more globalised discrimination associating women, people of colour, redheads, and many more to evil magic or curse-bound[^6]. I personally picture magic as a huge reclaiming force.   
...
- Both the web and magic share a certain playfulness  
	- The web is a great place to experiment, mess around, various browser extensions offer ways to customise and play around with websites, such as the one Doriane Timmermans brought to XPUB[^7] and which gave birth to the Supervisual Hyperzine[^8] last year. It is a huge playground.   
...
This idea took on quite rapidly, with the first net.artists[^9] rising as early as 1994 (the web itself was created in 1989 and made public in 1993!)   
  
Net.artists saw the potential of hyperlinks and inter-connectivity to create. In 2011, when HTML5 launched and eliminated frame elements[^10], Olia Lialina, a net.art pioneer[^11] and most active practitioner, told VICE Creators that since her work is often based on what browser developers see as bugs, she has to maintain and adapt, she has to “find new tricks” (Flood, 2011).    
...
Most of the Web Revival practices rely on principles such as hand-written code, low-weight websites, F/LOSS[^16] and sharing.     
...
`<!-- IMG: idea/spark (intuition) → intention → realisation (physical action). -->`    
In this process, intention is the key, it is what will make one say certain words, act a certain way. It injects politics in things, in the sense that intention is what will make us take action or not. To illustrate that a bit more poetically, here is an extract from a song: “Parler, c’est prendre position. Se taire, c’est prendre position” (Grand Corps Malade et al., 2022)[^20].  
...
- productivity, with for example the 3-clicks rule, stating that if a visitor has to use more than 3 clicks to access the content they’re looking for on a website, it is not worth their time[^26];  
- technicality, with the use of shady methods to design websites: frameworks and libraries, JavaScript generated HTML or closed databases[^27].  
...
```  
<!-- TOTAL CHAPT word count: 2597/2000 -->  
```  
...
While talking with Raphaël Bastide[^13], we agreed on a thing: magic resides in the balance between technicality and sensitivity. Let’s recognise the flaws of the machine and the ones of the living. For acknowledging them is the key to better embrace out sensitivity and create.  
...
```  
<!-- TOTAL CHAPT word count: 262/1000 >:( -->  
```  
  
```  
<!-- COMPLETE TOTAL word count: 10145/8000 -->  
```  
...
[^3]: https://pzwiki.wdka.nl/mediadesign/User:Kiara/Special_Issue_27/Time_is_not_my_friend  
  
[^4]: Khrys, IA, Philosophie du libre et Féminisme, 2025 (Accessible at: https://videos-libr.es/w/cKZQqzVxRfC9suiynb2yKt)  
  
[^5]: See Bougerol, 2026 or Lewis, 2021 or Lewis, 2020.  
  
[^6]: See Wicasta Lovelace’s introduction for the online unabridged republication of the Malleus Maleficarum (Lovelace, 2002).  
  
[^7]: Doriane Timmermans is an artist and researcher based in Bruxelles. She explores the materiality of the web, and more precisely of the CSS language, in her research project declarations. (https://declarations.style)<br>XPUB — Experimental Publishing is a master’s course offered at the Willem de Kooning Academy in Rotterdam, NL. It explores the notions of public(s), publication and experimental tech practices. (https://xpub.nl)<br>In 2025, Doriane was the guest tutor for XPUB’s Special Issue 26, for which she brought her declarations research to us students. (https://xpub.declarations.style/)  
  
[^8]: `<!-- see appendix – Hyperzine – TBD -->`  
  
[^9]: net.art refers to a group of artists who have worked in the medium of Internet art since 1994. […] <br>The term "net.art" is also used as a synonym for net art or Internet art and covers a much wider range of artistic practices. In this wider definition, net.art means art that uses the Internet as its medium and that cannot be experienced in any other way.  (https://en.wikipedia.org/wiki/Net.art)  
  
[^10]: “The &lt;frame&rt; HTML element defines a particular area in which another HTML document can be displayed. A frame should be used within a &lt;frameset&rt;.  
  
[^11]: Though often referred to as one of the net.art movement’s pioneer, it is important to note that in the 1960s, a lot of projects were already tackling what would become HTML, and the OuLiPo groups in France were exploring concepts close to algorithms. (https://en.wikipedia.org/wiki/History_of_the_World_Wide_Web#Background)  
  
[^12]: What You See Is What You Get.  
  
[^13]: `<!-- see apendix – conv with Raphaël – TBD -->`  
  
[^14]: The use of quotes here is to indicate that this is how leaders and rulers advertise and depict the society we live in, but it remains a highly subjective vision, that shouldn’t be used as a universal truth.  
  
[^15]: https://thoughts.melonking.net/guides/introduction-to-the-web-revival-1-what-is-the-web-revival  
  
[^16]: Free/Libre Open Source Software.  
  
[^17]: https://declarations.style  
  
[^18]: This selector would apply styling to an element on hover state but that is not focused. This is indeed quite mystique, thanks Doriane!  
  
[^19]: `<!-- see appendix – conv with Doriane – TBD -->`  
  
[^20]: “Speaking up is taking a stand Silence is taking a stand” (Grand Corps Malade et al., 2022)  
  
[^21]: https://ungual.digital/  
  
[^22]: https://moubarak.eu/#welcome  
  
[^23]: https://hackersanddesigners.nl/  
  
[^24]:  `<!-- As named by Raphaël Bastide, see Apendix … – TBD -->`  
  
[^25]: See: Burgy, 2020. and Maudet, 2022, p. 15  
  
[^26]: “It suggests that a user of a website should be able to find any information with no more than three mouse clicks. It is based on the belief that users of a site will become frustrated and often leave if they cannot find the information within the three clicks.” (Wikipedia, last updated: 03-03-2026)  
  
[^27]: See: Brochier, 2023. and neal.fun, 2020  
  
[^28]: https://moz.com/learn/seo/what-is-seo  
...
[^30]: “A method of banning users where their posts are visible only to them. Created to prevent spammers, trolls, and flamers from realizing they have been banned and creating new accounts." — *I’ve been posting right-wing crap all over the forum, but no one is biting. I think I’ve been shadowbanned.*” (Urban Dictionary, 2011)  
  
[^31]: Neocities works in the same way as GeoCities did (see note 34). A paid plan is available for $5/month that unlocks additional features such a custom domain. (https://neocities.org/about)  
  
[^32]: “GeoCities, later Yahoo! GeoCities, was a web hosting service that allowed users to create and publish websites free of charge, and to browse user-created websites by their theme or interest, active from 1994 to 2009.” (Wikipedia, last updated: 27-02-2026)  

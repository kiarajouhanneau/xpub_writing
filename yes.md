...
17-01-2026 word count: 550 

— CHAPTER ABOUT WEB CRAFT —
see: [[Thesis outline 2 (1500 w.)#1. Incantations and spells (2000)|Thesis outline 2 (1500 w.) > 1. Incantations and spells (2000)]] & [[DRAFT v1#1. Incantations and spells (2000)|DRAFT v1 > 1. Incantations and spells (2000)]]

From the beginning of the web, Tim Berners-Lee, its inventor, viewed it as a way of connecting all the people of the world together and a great opportunity to expand creativity and imagination (Berners-Lee, T. (2025) This is for everyone. Macmillan, London). This idea took on quite rapidly, with the first net.artists rising as early as 1994 (the web itself was created in 1989 and open to the public in 1993!)
Net.artists saw the potential of hyperlinks and inter-connectivity to create, the most active practitioner being Olia Lialina. ~~still acting nowadays on the preservation of early web through the One Terabyte of Kilobyte Age[^1] project she leads with Dragan Espenschied, documenting the GeoCities archive. A lot of her work showcase the many possibilities of hyperlinks, notably~~ On artsy.net we can read: “In 1996, her browser-based piece My Boyfriend Came Back From The War made her a notable pioneer of internet art. Her click-to-reveal storyline about reunited lovers was built on HTML frames, a newly-released feature that let developers put multiple pages in one browser. She wasn’t just translating a story onto the internet, she was telling a story in the language of the web browser”[^1]. *Telling a story with the language of the web* – this is beautiful and very à propos as web poetry might/will be mentioned. Later, in 2013, Lialina built *Summer*, a webring working across 26 websites, based on an animated GIF of a woman on a swing. The GIF was split in still images and the webring connects every image to the following by having every website included hosting one image. This ring is particularly interesting for the fact that it plays by itself, it doesn’t need a single click to operate, only network connection and maintenance from the web makers. In 2011, when HTML5 eliminated frame elements, Lialina told Creators’ Kathleen Flood that “Many of my works were based on features that browser developers considered being bugs and were removing those bugs in newer versions, so, I have to find new tricks to keep them alive.” I believe this is a perfect definition of crafting; inflating life into ideas with the means at our disposal, adapt to change to maintain the unexpected, hack – in the sense of using inappropriate or unexpected means to create or perform an action.
This notion of ‘unexpected’ is also 


The aesthetics of the early web result from a combination of experimentation, freedom and self-expression. The early web was in motion, full of textures, expanding the crafty practices we knew. **look for something in Kendal Beynon’s work to quote as example**

Crafting makes a lot of sense when speaking of website making for it is a form of expression, and as explained above, an art form. In her book *Reading Writing Interfaces: From the Digital to the Bookbound* (University of Minnesota Press 2014), Lori Emerson refers to crafting as experimentation: “Learning through doing, tinkering, experimentation, trial-and-error is, then, how one comes to have a genuine computer literacy.” This can make one reach the following conclusion: even the most stereotypical developer, having done their curriculum in programming, maths and engineering is making art, in the sense that they are writing, and the trial-and-error, drafting process is very similar.

*The following needs some smooth connection to the part about crafting, a nice little transition:*
Here again, the floor is shared: magic is also full of crafting. From the most obvious love potion to the most mystical meditation, every practice involves the body (often this of a channelling person, usually the “magic” person (e.g. fortune teller)) and sometimes even some specific gestures to reproduce to reinforce the power of intention.
Now that this has been laid down, we can dive deeper. Magic and the web share quite some characteristics and practices. As they are both relying on language and craft, the third shared pillar is intention. As stated in the beginning of this article, words bear meaning, making the process of choosing words an ongoing display of intention. What do I want to say, convey, share? The answer to those questions is the resulting intention. That very same intention then gets put into action; this is where we reconnect to crafting, and the web. 

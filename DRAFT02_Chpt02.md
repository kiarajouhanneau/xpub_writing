---
title: The Wicked Witch of the World Wide Web -- Chapter 2
author:
  - Kiara Jouhanneau
description: |-
...
- productivity, with for example the three-click rule, stating that if a visitor has to use more than three clicks to access the content they’re looking for on a website, it is not worth their time[^1];  
...
This is the principle of technocapitalism[^3]; big corporations set rules that aim to ensure them money gain, and smaller companies or individuals are left with no other choice than “following the trend”. This makes it very hard for independent artists or beginners to make room for their practice. They remain out of the first page of search results, invisible, shadow-banned[^4] in a way.   
Those implicit rules are set so hard in stone that they have been going on for more than 20 years, enforced by the rules of the website-building platforms. For example, wix.com expects that the template “follows the good practices of of UX/UI design and the trends of its field”[^5].   

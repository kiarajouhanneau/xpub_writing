---
title: The Wicked Witch of the World Wide Web -- Chapter 1
author:
  - Kiara Jouhanneau
description: |-
...
>“In 1996, her browser-based piece My Boyfriend Came Back From The War made her a notable pioneer of internet art. Her click-to-reveal storyline about reunited lovers was built on HTML frames, a newly-released feature that let developers put multiple pages in one browser. She wasn’t just translating a story onto the internet, she was telling a story in the language of the web browser”[^2].

<!--- IMG: My Boyfriend Came Back From The War + Summer --->

*Telling a story with the language of the web* – this is beautiful and very à propos as web poetry might/will be mentioned.  
...
Now that this has been laid down, we can dive deeper. I asked myself, what is the glue that keeps politics, language, playfulness, the web and that touch of magic together, the answer is purpose.
...
My personal view of magic is ruled by intention, intention is what will make one say certain words, act a certain way. That same intention should be, I believe, at the core of website making. That same intention injects politics in things. As mentioned above, magic is a process and this process can be applied to any aspect of our lives. Here I am focusing on web crafting, so I will develop my argument accordingly.   
Crafting a website starts with a spark, an idea let’s say. Then, we act upon it to give life to that website. Every choice along the way is ruled by intention(s) and intuition(s). However, what differentiates web crafting from built-in drag-and-drop WYSIWYG[^4] website makers is attention. Attention to detail, to the public/audience, to the website itself. This is what Raphaël Bastide depicts in his performative piece being a script.   
...
In a conversation[^5] we had together, Raphaël told me about the creation process of this piece. How he started writing it during the first months of his newborn daughter, the role and place taken by the body and physical gestures in this process. He also told me about the questions at the heart of this creation: 
...
Back in its first years of life, the web did not have such “powerful” search engines and discovering new websites was more of a treasure hunt. To compensate for this lacking, web-makers created webrings: a script file was put in the code folder, containing a list of all members and a looping function, interlinking members to one another. Those early webring were thematic: gardeners, fandoms, cooking websites, etc. It allowed visitors to discover other people having the same passions or interests. <!--- IMG: webrings examples --->  
For a few years now, webrings are showing up again, regaining popularity. Of course not for the reason, but they still act as a very good discovery/connecting tool. This revival is linked to a movement of revolt, a common voice rising from the depths of the web: the indie web. It is a practice born from a desire of reclaiming the web space, taken over by big corporations (GAFAM[^6]). It relies on principles such as hand-written code, low-weight websites, F/LOSS[^7] and sharing.[^8] It advocates for personal websites as a form of expression, opposite to corporate-owned social media platforms, for they invite us to care about what we share and how.  
...
We can pull on that rope and reach analogies to magic craft itself – here referring to practices pertaining to ritual and spell casting.  
Webrings mirror magic circles: both use the circle shape and its attributes of constant sharing and flow, thus serving as ways of gathering and performing (magic circles perform a ritual, webrings perform a community).  
Digital gardens mirror books of spells and potions: collections of writings and experimentations that can be passed on and modified through time, acting as recipes, guides and heritage.  
In that sense, they are completely made by and for (a) community.  
To my knowledge, the most extensive depiction of that statement is what Daniel Murray, a.k.a melonking, built. Starting to build his own corner of the web in 2016, he now gathers hundreds of people on ‘MelonLand‘. His digital world includes his website, a forum, multiple webrings, a wiki, and more. In a interview he gave to Kendal Beynon he describes the ‘Everyone Site’, a feature of MelonLand:
> This came out of a workshop that I did in Brussels with Doriane Timmermans[^10]. At the workshop, we were doing experiments through the open-source online editor Etherpad. I was working with Karl Moubarak[^11] from the collective Hackers and Designers[^12]. He came up with this system where we could write JavaScript in the Etherpad and it would inject the JavaScript directly into a browser extension, which meant that you could basically collectively write code that could morph how people's browsers worked. It was a complete security nightmare, but I thought that was a really exciting idea. The Everyone Site (eSite) is essentially that idea of collective programming applied to a web server and moderated by the forums community.  
...
> Laurel Schwulst
>>Trousdale, A. Laurel Schwulst is a Professor — Welcome to New Possibilities. Available at: https://apossible.com/interviews/laurel-schwulst-is-a-professor (Accessed: 17 December 2025).
>> Schwulst, L. (2018) My website is a shifting house next to a river of knowledge. What could yours be?, The Creative Independant. Available at: https://thecreativeindependent.com/essays/laurel-schwulst-my-website-is-a-shifting-house-next-to-a-river-of-knowledge-what-could-yours-be/ (Accessed: 8 October 2025).
>> Haile, N. (2019) On Becoming a Person | inform.design, inform.design. Available at: https://inform.design.calarts.edu/2019/03/laurel-schwulst/ (Accessed: 8 January 2026).
...
[^2]: https://www.artsy.net/artwork/olia-lialina-summer-1

[^3]: https://www.artsy.net/artwork/olia-lialina-summer-1

[^4]: What You See Is What You Get

[^5]: see apendix – notes of discussion

[^6]: les 5 géants du web, aussi appelés GAMAM ou Big Five: Google (Alphabet), Apple, Facebook/Meta, Amazon, Microsoft

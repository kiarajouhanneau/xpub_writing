...
3. Both the web and magic share a certain playfulness  
	1. The web is a great place to experiment, mess around, various browser extensions offer ways to customise and play around with websites, such as the one Doriane Timmermans brought to XPUB and which gave birth to the Supervisual Hyperzine<sup>(refer to appendix; image)</sup> last year. It is a huge playground.   
	2. Magic, as I envision it, brings up a certain curiosity, an urge to experiment with it in order to make it ours. It could even be linked back to language for the fact that many fictional magic words sound a bit silly: “hocus pocus”, “open sesame”, “alakazam”, etc. – the [wiki page for Magic word](https://en.wikipedia.org/wiki/Magic_word) has a bunch of them.  
  
Now that this is cleared out, let me introduce the core of my research: I intend to seek how, in a hyper-marketable world, ruled by seamlessness, polished Instagram feeds and machine-generated content, how can we fight the rising technofascism and (re)shape the web by embracing the useless, reconnecting to the fun and reclaiming our singularity?  
...
This idea took on quite rapidly, with the first net.artists[^8] rising as early as 1994 (the web itself was created in 1989 and made public in 1993!)    
...
> “Many of my works were based on features that browser developers considered being bugs and were removing those bugs in newer versions, so, I have to find new tricks to keep them alive.”[^9]  
...
> A garden is a collection of evolving ideas that aren’t strictly organised by their publication date. They’re inherently exploratory – notes are linked through contextual associations. They aren’t refined or complete – notes are published as half-finished thoughts that will grow and evolve over time. They’re less rigid, less performative, and less perfect than the personal websites we’re used to seeing.[^15]  
  
A digital garden is like a notebook, shared for other people to flip through.    
  
Here, we observe something interesting: one practice is very close to the one of clubs – as in a book club –, a gathering of people *around* a shared passion; the other takes gardening, an activity highly *centred* on care and patience, as a metaphor for its form.  
...
[^2]: definition: single source publishing  
  
[^3]: link to synthetica somewhere  
  
[^4]: link to wiki page  
  
[^5]: link to Khrys about GenAI as ideology  
  
[^6]: Ref to Musk & Trump, extrême droite en France  
...
[^15]: https://maggieappleton.com/garden-history/  
  
[^16]: source???  
  
[^17]: https://www.artsy.net/artwork/olia-lialina-summer-1  
...
[^27]: quoted by Nolwenn Maudet in Fast publication : l’homogénéisation visuelle des templates web comme conséquence du prêt-à-publier (2024. Available at: https://journal.dampress.org/varia/fast-publication-l%27homogeneisation-visuelle-des-templates-web-comme-consequence-du-pret-a-publier.a1c9cc3472d2e2acbe2fe55a4870d75c)  
...
[^29]: Cardon, D. (2015, p. 70) À quoi rêvent les algorithmes ? Nos vies à l’heure du big data, Paris, Seuil., quoted by Nolwenn Maudet in Algorithms vs Interactions: The Revenge of Artificial Intelligence over Design (2024. Available at: https://networkcultures.org/longform/2024/09/05/algorithms-vs-interactions-the-revenge-of-artificial-intelligence-over-design/)  

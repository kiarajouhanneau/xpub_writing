...
> “Some individuals have defended large language models by saying that most of what human beings say or write isn’t particularly original. That is true, but it’s also irrelevant. […] If someone is being sincere, their apology is valuable and meaningful, even though apologies have previously been uttered. Likewise, when you tell someone that you’re happy to see them, you are saying something meaningful, even if it lacks novelty.” (Chiang, 2024).  
 ...
 Ultimately, this make the useless and the goofy preferred counter-action to GenAI advocates’ political agenda.  
...
[^3]: `<!-- link to synthetica somewhere -->`  
...
[^23]: As named by Raphaël Bastide, see Apendix …  
...
[^30]: `<!-- Description: Neocities`  
  
[^31]: `<!-- Description: Geocities -->`  
  
[^32]: `<!-- Cite wwwobble and others small website builders -->`  
...
[^41]: `<!-- Link to Cyberpunk: Edgerunners -->`  
...
[^44]: flex-box is a CSS layout property that allows a somewhat flexible grid layout for a web page.  
  
[^45]: `<!-- explain what Geocities is -->`  
